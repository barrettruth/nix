...
-- hl.bind("ALT + CTRL + S", hl.dsp.exec_cmd("hypr pull signal-desktop"))
-- hl.bind("ALT + CTRL + E", hl.dsp.exec_cmd("hypr pull element-desktop"))
-- hl.bind("ALT + CTRL + G", hl.dsp.exec_cmd("hypr pull telegram-desktop"))
...
-- hl.bind("ALT + SHIFT + S", hl.dsp.exec_cmd("hypr spawnfocus --ws 6 signal-desktop"))
-- hl.bind("ALT + SHIFT + E", hl.dsp.exec_cmd("hypr spawnfocus --ws 8 element-desktop"))
-- hl.bind("ALT + SHIFT + T", hl.dsp.exec_cmd("hypr spawnfocus --ws 9 telegram-desktop"))
