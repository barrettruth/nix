(function (a, b) {
  ...
  function s(a) {
    return a instanceof z ? a : new A(a);
  }
  function t(a, c, d) {
    function e(l, m, n) {
      if (!m.length) return h.ignoredScore;
      if (m.length > l.length) return 0;
      for (var o = d && d.length, p = m.length; 0 < p; p--) {
        if (k > h.maxIterations) return 0;
        k++;
        var q = g.substring(m.location, m.location + p),
          r = u(f, q, new w(l.location, l.length - m.length + p));
        if (r.isValid()) {
          (n.location = n.isValid() ? b(n.location, r.location) : r.location),
            n.max(r.max()),
            d && d.push(r.toArray());
          var s = new w(r.max(), l.max() - r.max()),
            t = new w(m.location + p, m.length - p),
            v = e(s, t, n);
          if (v) {
            var x = s.location - l.location,
              y = !0,
              z = h.useSkipReduction(a, c, v, s, l, s, r, n);
            if (r.location > l.location)
              if (z && -1 < h.wordSeparators.indexOf(a[r.location - 1]))
                for (var A = r.location - 2; A >= l.location; A--)
                  -1 < h.wordSeparators.indexOf(a[A])
                    ? x--
                    : (x -= h.skippedScore);
              else if (z && -1 < h.uppercaseLetters.indexOf(a[r.location]))
                for (var B = r.location - 1; B >= l.location; B--)
                  -1 < h.uppercaseLetters.indexOf(a[B])
                    ? x--
                    : (x -= h.skippedScore);
              else (x -= r.location - l.location), (y = !1);
            return (
              (x += h.adjustRemainingScore(a, c, v, y, l, s, r, n)),
              (x /= l.length),
              x
            );
          }
    ...
    var f =
      ...
      g =
        4 < arguments.length && arguments[4] !== void 0
          ? arguments[4]
          : c.toLocaleLowerCase(),
      h = 5 < arguments.length && arguments[5] !== void 0 ? arguments[5] : B,
      i =
        6 < arguments.length && arguments[6] !== void 0
          ? arguments[6]
          : new w(0, a.length),
      k = 0;
    return c ? e(i, new w(0, c.length), new w()) : h.emptyQueryScore;
  }
  function u(a, b, c) {
    var d = a.indexOf(b, c.location),
      e = new w();
    return (
      -1 < d && d < c.max() && ((e.location = d), (e.length = b.length)), e
    );
  }
  function v(a) {
  ...
  var w = (function () {
      function a() {
        ...
        c(this, a), (this.location = b), (this.length = d);
      }
      return (
        e(a, [
          {
    ...
    x = {
      ...
      uppercaseLetters: (function () {
        for (var a = [], b = 0; 26 > b; b++)
          a.push(String.fromCharCode(65 + b));
        return a.join("");
      })(),
      ignoredScore: 0.9,
      skippedScore: 0.15,
    ...
    z = (function () {
      function a(b) {
        c(this, a), Object.assign(this, x, b);
      }
      return (
        e(a, [
          {
    ...
    A = (function (a) {
      function d(a) {
        return c(this, d), g.call(this, Object.assign({}, y, a));
      }
      f(d, a);
      var g = l(d);
      return (
        e(d, [
          {
            ...
            value: function (a, b, c, d, e, f, g) {
              var h = a.length,
                i = h <= this.longStringLength,
                j = g.location / h;
              return i || j < this.maxMatchStartPct;
            },
          },
          {
            key: "adjustRemainingScore",
            value: function (a, c, d, e, f, g, h, i) {
              var j = a.length <= this.longStringLength,
                k = i.location / a.length,
                l = 1,
                m = 1 - k;
              return (
                e ||
  ...
  var E = (function () {
    function a() {
      ...
      c(this, a);
      var e = Array.isArray(d) ? { keys: d } : d,
        f = e.scorer,
        g = void 0 === f ? t : f,
        h = e.transformString,
        i = void 0 === h ? v : h,
      ...
      (this.scorer = g),
        (this.minimumScore = o),
        (this.config = p),
        (this.transformStringFunc = i),
        "function" == typeof g.createConfig &&
          (this.config = g.createConfig(p)),
        this.setKeys(k, m),
        this.setItems(b),
    ...
    return (
      e(a, [
        ...
        },
        {
          ...
          value: function (a, b) {
            if (
              ((this.keys = a.slice()), (this.sortKey = b), this.keys.length)
            ) {
              var c = this.scorer;
              (this.keys = this.keys.map(function (a) {
                var b = a.length ? { name: a, scorer: c } : a;
