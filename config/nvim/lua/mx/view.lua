...
function M.close()
    ...
    if #vim.api.nvim_list_tabpages() <= 1 then
        return require('mx.server').close()
    end
    local bufs = {}
...
function M.setup()
    ...
    did_setup = true
    local group = vim.api.nvim_create_augroup('mx-view', { clear = true })
