  ...
  programs.waybar = {
    ...
    settings.mainBar = {
      ...
      "custom/pulseaudio" = {
        ...
        on-click-right = "notify-send test 'right click fired'; pgrep -f 'waybar.*slider' && pkill -f 'waybar.*slider' || hyprctl dispatch exec 'waybar -c ${config.xdg.configHome}/waybar/slider.json'";
